...
! starting values ystart from x1 to x2 with accuracy eps, storing intermediate 
! results in the module variables in ode path. h1 should be set as a guessed  
! rst stepsize, hmin as the minimum allowed stepsize (can be zero). On output 
! ystart is replaced by values at the end of the integration interval. derivs 
! is the user-supplied subroutine for calculating the right-handside 
