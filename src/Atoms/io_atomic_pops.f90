...
MODULE io_atomic_pops
 ...
 SUBROUTINE write_Electron(write_ne_nlte)
 ! ------------------------------------ !
...
!   enddo
 ...
 RETURN
 END SUBROUTINE read_Pops


 !!!!!!!!!! BUILDING !!!!!!!!!!!!!!!
 SUBROUTINE read_Electron(fileNe)
 ! ------------------------------------ !
