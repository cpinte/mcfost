...
! - spectre_etoiles_cumul, spectre_etoiles
  ...
  if (etoile(1)%lb_body) then ! les �toiles sont des corps noirs
  ...
  do i=1,n_etoiles
     ...
     do lambda=1, n_lambda
        ...
        ! delta_wl est la largeur du bin d'int�gration
...
subroutine find_spectra()
  ...
  subroutine compute_stellar_parameters()
    ...
    do i=1, n_etoiles
       ...
       write(*,*) "Star #",i,"  Teff=", etoile(i)%T, "K, r=", real(etoile(i)%r), "Rsun", "is BB?", etoile(i)%lb_body
    enddo
