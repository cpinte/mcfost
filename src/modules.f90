...
!****************************
  ...
  character(8), parameter :: mcfost_release = "3.0.30"
  ...
  logical :: ldensity_file, lsigma_file, lvelocity_file, lphantom_file, lgadget2_file, lascii_SPH_file, llimits_file, ldiskevol_file
