...
!****************************
  ...
  logical :: ldensity_file, lsigma_file, lvelocity_file, lphantom_file, lphantom_hdf_file, lphantom_multi, lphantom_avg, lgadget2_file, lascii_SPH_file, llimits_file, lSPH_amin, lSPH_amax
